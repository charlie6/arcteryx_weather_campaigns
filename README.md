...
| **Samples** | [`infra/config/samples/arcteryx_sandbox_firestore_config.json`](infra/config/samples/arcteryx_sandbox_firestore_config.json) | Firestore seed for the sandbox account; `deploy.sh` uploads it by default. Generated by `infra/scripts/config/generate_sample_configs.py`. |
| **Samples** | [`infra/config/samples/arcteryx_test_firestore_config.json`](infra/config/samples/arcteryx_test_firestore_config.json) | Illustrative multi-city seed used by the tests. Generated by the same script. |
